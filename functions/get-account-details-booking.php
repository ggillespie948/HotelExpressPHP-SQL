...
while ($row = mysql_fetch_array($result)) {
    ...
    echo "<a> Date of Arrival </a>";
	echo $day." ".$month.".$year."."<input type='hidden' name='date' value='".$day."'></td><td><br>";
        
    echo "<a> Number of nights stay </a>";
	echo $nights."<input type='hidden' name='telephone_no' value='".$row["telephone_no"]."'></td><td><br>";
